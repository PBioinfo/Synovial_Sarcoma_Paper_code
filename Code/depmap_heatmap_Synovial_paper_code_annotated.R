...
depmap <- readRDS("./Data/depmap_21Q3_screen_data.rds")
...
Genes_Syn = readxl::read_excel("./Data/Synovial_Sarcoma_List_for_Heatmap.xlsx", sheet =1) %>%
  as.data.frame()
Genes_Syn = Genes_Syn$`Gene/Compound`
Genes_to_map = readxl::read_excel("./Data/Complexes_for_HeatMap.xlsx", sheet =2) %>%
  as.data.frame()
...
df_squareview = read.csv("./Data/dataframe_squareview_rnai.csv", header = T) 
...
## -----------------------------------
Sweave("./Data/Day14_vs_Day0_sample_rra_summary.Rnw");


## -----------------------------------
## Figure 2C
## -----------------------------------
Sweave("./Data/Mouse_vs_Day0_sample_rra_summary.Rnw");
