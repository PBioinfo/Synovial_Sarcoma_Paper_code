...
library(xtable)
filelist=c("/data1/fpramodakulabala/DeshpandeLab/CRISPR_screen ing_Data_Analysis/MAY_2023/Fastqs/Rep1Day0/Rep1Day 0_CKDL230011517-1A_H5LYGDSX7_L1_1.fastq","/data1/fpramodakulabala/DeshpandeLab/CRISPR_screen ing_Data_Analysis/MAY_2023/Fastqs/Rep1Day14/Rep1Da y14_CKDL230011517-1A_H5LYGDSX7_L1_1.fastq","/data1/fpramodakulabala/DeshpandeLab/CRISPR_screen ing_Data_Analysis/MAY_2023/Fastqs/Rep1Mouse2/Rep1M ouse2_CKDL230011517-1A_H5LYGDSX7_L1_1.fastq","/data1/fpramodakulabala/DeshpandeLab/CRISPR_screen ing_Data_Analysis/MAY_2023/Fastqs/Rep1Mouse3/Rep1M ouse3_CKDL230011517-1A_H5LYGDSX7_L1_1.fastq","/data1/fpramodakulabala/DeshpandeLab/CRISPR_screen ing_Data_Analysis/MAY_2023/Fastqs/Rep2Day0/Rep2Day 0_CKDL230011517-1A_H5LYGDSX7_L1_1.fastq","/data1/fpramodakulabala/DeshpandeLab/CRISPR_screen ing_Data_Analysis/MAY_2023/Fastqs/Rep2Day14/Rep2Da y14_CKDL230011517-1A_H5LYGDSX7_L1_1.fastq");
labellist=c("Rep1Day0","Rep1Day14","Rep1Mouse2","Rep1Mouse3","Rep2Day0","Rep2Day14");
reads=c(27306467,4291755,5658236,10861051,5647567,5479574);
mappedreads=c(21854232,3394352,4457673,8530791,4521533,4052307);
totalsgrnas=c(3653,3653,3653,3653,3653,3653);
zerocounts=c(48,50,54,56,46,47);
giniindex=c(0.05535578467680724,0.09664600833658366,0.14232538006380901,0.13529436968885922,0.05794753841567868,0.09683935911383623);
...
genboxplot("SySa-DepMap_co_ctrl_sample.count_normalized.txt");
@
...
genhistplot("SySa-DepMap_co_ctrl_sample.count_normalized.txt");
@
...
genpcaplot("SySa-DepMap_co_ctrl_sample.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("SySa-DepMap_co_ctrl_sample.count_normalized.txt");
@
